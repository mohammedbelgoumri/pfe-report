...
À fin d'obtenir une phrase, le décodeur est appelé auto-régressivement avec la phrase vide comme grain.
À chaque étape, il génère un mot en utilisant la loi de probabilité.
Ce mot est ajouté à la phrase et le décodeur est appelé auto-régressivement sur la phrase ainsi obtenue.

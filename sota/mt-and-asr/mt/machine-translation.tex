...
Par exemple, elle est mathématiquement définie dans le contexte de compilation%
...
~\cite{Hadj_2015}.
Elle a par contre une définition floue dans le contexte de la \gls{mt} du langage naturel~\cite{routledge}.
Notre contexte de \gls{mt} pour la correction des erreurs%
\footnote{%
...
La plupart des succès sont des exemples de \gls{nmt}~\cite{deep-nmt-survey}.

\subsection{Classification des méthodes de traduction automatique}

La classification des méthodes de \glsxtrshort{mt} la plus citée à travers la littérature, 
...
\subimport{}{rbmt}
\subsection{Traduction automatique statistique}

...
\begin{figure}[htb]
    \centering
    \resizebox{8cm}{!}{\input{assets/tikz/gating.tex}}
...
\begin{figure}[htb]
    \centering
    \resizebox{8cm}{!}{\input{assets/tikz/gru.tex}}
    \caption[Architecture interne d'un \glsfmtshort{gru}]%
    {Architecture interne d'un \glsfmtshort{gru}~\cite[Fig. 1b]{Chung_Gulcehre_Cho_Bengio_2014}}
...
\begin{figure}[htb]
    \centering
    \resizebox{8cm}{!}{\input{assets/tikz/lstm.tex}}
    \caption[Architecture interne d'un \glsfmtshort{lstm}]%
    {Architecture interne d'un \glsfmtshort{lstm}~\cite[Fig. 1a]{Chung_Gulcehre_Cho_Bengio_2014}}

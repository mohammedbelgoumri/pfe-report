...
\begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=6cm]{assets/images/bytenet.png}
    \captionof{figure}{L'architecture de ByteNet.}
    \label{fig.bytenet}
\end{minipage}
\begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=6cm]{assets/images/convs2s.png}
    \captionof{figure}{L'architecture de ConvS2S.}
    \label{fig.convs2s}
\end{minipage}

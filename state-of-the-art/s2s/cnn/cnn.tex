...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=.6\textwidth]{assets/images/bytenet.png}
    \caption{L'architecture de ByteNet.}
    \label{fig.bytenet}
\end{figure}

\begin{figure}[hbt]
    \centering
    \includegraphics[width=.6\textwidth]{assets/images/convs2s.png}
    \caption{L'architecture de ConvS2S.}
    \label{fig.convs2s}
\end{figure}

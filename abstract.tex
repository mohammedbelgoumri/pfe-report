\begin{abstract}
    ...
    Ensuite, nous menons une étude bibliographique sur les travaux existant sur 
    la \glsxtrlong{mt} et la la \glsxtrlong{asr}.
    Enfin, nous proposons et réalisons un système de \glsxtrlong{mt} de la parole aphasique en Français.
    %%
    \\[2cm]
    %%
    \rule{\linewidth}{1pt}
...
\begin{otherlanguage}{english}
    \begin{abstract}
        ...
        We finish by designing and creating a translation system for french aphasic speech.
        %%
        \\ [2cm]
        %%
        \rule{\linewidth}{1pt}
...
\begin{abstract}
    ...
    \begin{RLtext}
        ...
        نـخـتـم أخـيـرا بـتـصـمـيـم وإنـجـاز نـظام تـرجـمـة آلـيـة لـحـبـسـة بـروكـا فـي اللـغـة الـفـرنـسـيـة.
    \end{RLtext}
    \rule{\linewidth}{1pt}
    \begin{RLtext}

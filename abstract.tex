\begin{abstract}
    ...
    Dans ce but, menons une étude bibliographique dans laquelle 
...
\begin{otherlanguage}{english}
    \begin{abstract}
        ...
        To this end, we conduct a bibliographical study in which introduce aphasia, its causes, consequences, 
...
\afterpage{
    ...
    \begin{abstract}
        ...
        \setcounter{page}{3}
        \fancypagestyle{plain}{\fancyhf{}\cfoot{\thepage}}
        \phantomsection\addcontentsline{toc}{chapter}{\textRL{ملخص}} 
        \begin{RLtext}
            ...
            مـن أجـل ذلك، نـعـرض دراسـة بـيـبـلـيـوغـرافـيـة نـعـرف فـيـهـا

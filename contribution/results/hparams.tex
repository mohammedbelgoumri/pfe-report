...
\begin{figure}[hbt]
    ...
    \end{center}
    \caption{Évolution du score \glsfmtshort{bleu} au cours du réglage des hyperparamètres.}
...
On observe sur la Figure~\ref{fig.results.hparams} un regroupement des lignes oranges (les meilleurs essais) 
